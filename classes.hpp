...
namespace antagonist
{
	namespace offsets
	{
		...
		constexpr std::uint32_t model_instance = 0x2A8;
...
//			antagonist::roblox::instance_t get_cframe();
			std::uintptr_t get_gameid();

			antagonist::roblox::instance_t get_workspace();
			antagonist::roblox::instance_t get_current_camera();
